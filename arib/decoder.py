...
class Decoder(object):
    ...
    def __init__(self):
        ...
        # NOTE: The standard says this part of the encoder should be initialized
        # to Alphanumeric (as in the comment)
        # But practice dictates it should be Katakana. This may be due to my using
        # improper or partial .ts files to test,
        # or perhaps it's a side effect of a bug in my code, but untill I have sources
        # that produce better behavior, this will stand.
